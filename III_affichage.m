...
subplot(1,3,1)
plot(freq_grid(M+1+d:M+1+u), pos_amp_c1_MP(d:u),'b',[f_th(1) f_th(1)],[0 A_th(1)],'r',[f_th(2) f_th(2)],[0 A_th(2)],'r',[f_th(3) f_th(3)],[0 A_th(3)],'r',[f_th(4) f_th(4)],[0 A_th(4)],'r',[f_th(5) f_th(5)],[0 A_th(5)],'r') 
title('MP Method for x1')
xlabel('Frequency')
ylabel('Amplitude')
grid()
...
subplot(1,3,2)
plot(freq_grid(M+1+d:M+1+u), pos_amp_c1_OMP(d:u),'b',[f_th(1) f_th(1)],[0 A_th(1)],'r',[f_th(2) f_th(2)],[0 A_th(2)],'r',[f_th(3) f_th(3)],[0 A_th(3)],'r',[f_th(4) f_th(4)],[0 A_th(4)],'r',[f_th(5) f_th(5)],[0 A_th(5)],'r') 
title('OMP Method for x1')
xlabel('Frequency')
ylabel('Amplitude')
grid()
...
subplot(1,3,3)
plot(freq_grid(M+1+d:M+1+u), pos_amp_c1_OLS(d:u),'b',[f_th(1) f_th(1)],[0 A_th(1)],'r',[f_th(2) f_th(2)],[0 A_th(2)],'r',[f_th(3) f_th(3)],[0 A_th(3)],'r',[f_th(4) f_th(4)],[0 A_th(4)],'r',[f_th(5) f_th(5)],[0 A_th(5)],'r') 
title('OLS Method for x1')
xlabel('Frequency')
ylabel('Amplitude')
grid()
